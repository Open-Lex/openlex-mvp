...
_EXTRACTION_SYSTEM = (
    ...
    "FELD rechtssystem_tiefe: NUR wenn der Kontext einen 'SACHVERHALTSTIEFE'-Abschnitt "
    "zeigt — befülle dann die dort aufgeführten Felder mit dem, was der Nutzer gesagt hat "
    "(auch wenn er es nur implizit erwähnte). Nur die explizit gelisteten Felder, nichts "
    "erfinden. null, wenn kein Tiefe-Block im Kontext vorhanden.\n"
