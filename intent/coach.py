...
_EXTRACTION_SYSTEM = (
    ...
    "zu \"Arbeitgeber\").\n\n"
    "SONDERFALL Rechtsprechungs-/Urteils-Anfragen:\n"
    "Fragt der Nutzer nach einem konkreten Gerichtsurteil, Leitfall oder einer "
    "Rechtsprechung (Signale: '[Name]fall', 'BGH', 'OLG', 'BVerfG', 'Urteil', "
    "'Entscheidung', 'Rechtsprechung', 'was sagt das Gericht', 'Leitentscheidung', "
    "'Grundsatzurteil', 'Paragrafenkette'), DANN:\n"
    "  • setze genug_infos=true und naechste_frage=null (KEINE Slot-Fragen stellen!)\n"
    "  • wer='Anfragender', was='rechtliche Einschätzung/Urteilsinhalt', "
    "von_wem='Gericht/Gegenseite laut Urteil', woraus='[Fallname] / Rechtsprechung'\n"
    "  • route zum fachlich passenden Rechtsgebiet (z.B. Parkettstäbefall→sachenrecht, "
    "Lüth-Urteil→grundrechte, Schuldrechtsreform-Fälle→kaufrecht)\n"
    "  Der Nutzer fragt nach Wissen, nicht nach Hilfe in einem eigenen Fall — "
    "KEINE Rückfragen zu 'Wer ist Anspruchsgegner?' o.ä.\n\n"
    "BEISPIELE für naechste_frage:\n"
    "- VERBOTEN (Allgemeinplatz): \"Was soll am Ende dabei herauskommen?\" / "
    "\"Gegen wen richtet sich das?\"\n"
    "- VERBOTEN bei Urteilsanfrage: \"Wer ist Anspruchsgegner?\" / "
    "\"Wer ist die andere Seite?\" — der Nutzer fragt nach Rechtsprechung!\n"
    ...
    "- GUT bei \"was sagt der Parkettstäbefall\": sofort genug_infos=true, "
    "woraus='Parkettstäbefall BGH', route→sachenrecht (§ 950 BGB Verarbeitung).\n"
